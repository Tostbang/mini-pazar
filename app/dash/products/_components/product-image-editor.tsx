...
async function fileToImageSource(
  file: File,
...
export function ProductImageEditor({
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const finalBlob = await resizeIfNeeded(workingBlob);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[92vh] max-w-4xl overflow-hidden p-0 sm:p-0">
        <DialogHeader className="border-b border-border px-6 py-4">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <DialogDescription>
                Görseli ürün kartlarına uygun şekilde hazırlayın. Arka plan
                kaldırma varsayılan olarak açıktır.
              </DialogDescription>
            </div>
            <button
              type="button"
        ...
        <div className="grid gap-0 sm:grid-cols-[1fr_280px]">
          ...
          <aside className="flex flex-col gap-4 border-l border-border bg-card p-5">
            ...
            <div className="mt-auto rounded-xl bg-muted/40 p-3 text-[11px] leading-relaxed text-muted-foreground">
              ...
              <p className="mt-1">
                Tüm ürün görselleri kare (1:1), şeffaf arka planlı ve 1280px
                sınırında olacak şekilde otomatik olarak hazırlanır.
              </p>
            </div>
          </aside>
        </div>
