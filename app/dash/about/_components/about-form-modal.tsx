    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[92vh] overflow-y-auto sm:max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>
            {isEdit
              ? "Başlık, görsel ve MDX açıklamayı güncelleyin."
              : "Hakkımızda bölümü için başlık, görsel ve MDX ile zenginleştirilmiş açıklama yazın."}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid gap-5 sm:grid-cols-[200px_1fr]">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input
                id="about-image-url"
                type="url"
                placeholder="https://… veya yandaki butondan yükleyin"
                value={imageUrl}
                onChange={(event) =>
              ...
              <p className="text-xs text-muted-foreground">
                Görsel isteğe bağlıdır. Soldaki butondan dosya yükleyebilir
                veya doğrudan bir URL yapıştırabilirsiniz.
              </p>

              <label className="mt-3 inline-flex cursor-pointer select-none items-center gap-2 text-sm font-medium text-foreground">
                <input
                  type="checkbox"
                  checked={isActive}
                  onChange={(event) =>
...
function ImagePicker({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <span className="text-sm font-semibold text-foreground">Görsel</span>
      <div
        {...triggerProps}
        className={cn(
