...
function CategoryThumbnail({
  ...
  // Emoji characters render as text; URLs fall back to Image.
  if (isEmojiCharacter(value)) {
    return (
      <div
        role="img"
        aria-label={alt}
        className="grid size-9 place-items-center rounded-lg border border-border bg-background text-xl leading-none"
      >
        {value}
      </div>
    );
...
// Heuristic: a string is an emoji character when it is short (1–2 graphemes)
// and contains no whitespace or path characters.
